            ...
            <div className="mt-8 space-y-6 animate-fade-in">
                {result.matches.length > 0 && (
                    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        <div className="bg-indigo-50 dark:bg-indigo-900/30 px-4 py-3 border-b border-indigo-100 dark:border-slate-700">
                            <h3 className="font-bold text-indigo-800 dark:text-indigo-200">{t.investigator_results_title}</h3>
                        </div>
