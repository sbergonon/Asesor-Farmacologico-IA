  ...
  const AnalysisModeSelector = () => (
    <div className="mb-6 flex justify-center p-1 bg-slate-200 dark:bg-slate-700/50 rounded-lg relative">
       <button
        ...
        className={`px-4 py-2 text-xs sm:text-sm font-semibold rounded-md transition-colors w-1/2 ${
      ...
      <div className="w-1/2">
        ...
        >
          <button
            ...
            className={`w-full px-4 py-2 text-xs sm:text-sm font-semibold rounded-md transition-colors flex items-center justify-center ${
              analysisMode === 'batch'
                ? 'bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 shadow'
                : 'text-slate-600 dark:text-slate-300 hover:bg-slate-300/50 dark:hover:bg-slate-600/50'
            }`}
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 flex flex-col font-sans">
      ...
      {showSessionRestoredToast && (
          <div className="fixed top-5 right-5 z-50 bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-200 px-4 py-3 rounded-lg shadow-lg flex items-center animate-pulse">
            ...
            <p className="font-bold text-sm">{t.session_restored_toast}</p>
          </div>
      )}
        ...
        <main className="mt-4 sm:mt-6">
            ...
            {!isDataLoading && activeTab === 'form' && (
              <>
                ...
                {analysisMode === 'individual' ? (
                  <div>
                      <div className="bg-white dark:bg-slate-800/50 p-4 md:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                          <InteractionForm
                              patientId={patientId}
                      ...
                      {error && (
                         <div className="mt-6 p-4 bg-red-100 dark:bg-red-900/50 border border-red-400 dark:border-red-600 text-red-700 dark:text-red-200 rounded-lg">
